			...
			<div class="container">
				<nav class="collapse navbar-collapse bs-navbar-collapse" role="navigation">
					<ul class="nav navbar-nav">
						...
						<li>
							<a href="#" data-toggle="modal" data-target=".levelup-practice-modal">模拟考试</a>
						</li>
						<li>
							<a href="#" data-toggle="modal" data-target=".practice-exampaper-modal">正式考试</a>
						</li>
						<li>
							<a href="admin/question-list">综合管理</a>
						</li>
					</ul>
				</nav>
			</div>

							...
							<div class="form">
								...
								action="user-reg">
									...
									<div class="form-group form-username">
										...
										<div class="col-md-7">
											<input type="text" class="form-control" id="name" style="background-color: #ffffff">
											<span class="form-message"></span>
										</div>
									...
									<div class="form-group form-email">
										...
										<div class="col-md-7">
											<input type="text" class="form-control" id="email" style="background-color: #ffffff">
											<span class="form-message"></span>
										</div>
									...
									<div class="form-group form-password">
										...
										<div class="col-md-7">
											<input type="password" class="form-control" id="password" style="background-color: #ffffff">
											<span class="form-message"></span>
										</div>
									...
									<div class="form-group form-password-confirm">
										...
										<div class="col-md-7">
											<input type="password" class="form-control" id="password-confirm" style="background-color: #ffffff">
											<span class="form-message"></span>
										</div>
